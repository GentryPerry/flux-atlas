...
export const NODE_TYPES = {
  character: {
    ...
    fields: [
      ...
      { key: 'politicalAllegiance', label: 'Political Allegiance', type: 'tags', default: [] },
  ...
  location: {
    ...
    fields: [
      ...
      { key: 'locationType', label: 'Location Type', type: 'select', default: 'city', options: ['city', 'state', 'town', 'district', 'landmark', 'region', 'settlement', 'outpost', 'other'] },
